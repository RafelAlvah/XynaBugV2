...
🌷 KALAU MAU RENAME TARO CREDITS GUA : XynaBotz*/
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC XynaBotz`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": ppnyauser,"sourceUrl": `https://youtube.com/@xynabotzreal`}}}, { quoted:m})} 
//=================================================//
...
Agar Bot Bisa Di Gunakan Silahkan Lihat Password Nya Di Channel YouTube XynaBotz'
 `,
footer: '© XynaBotz',
...
let user = global.db.data.users[m.sender]
m.reply(`
Hello Saya Bot XynaBotz${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC XynaBotz`,"body": `Selamat ${salam} kak ${pushname}`,
...
touchmebre = [
{
title: `🌷 XynaBotz WA 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(Pe, `🌷 XynaBotz WA 🌷`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
break
//=================================================//
...
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `XynaBotz${iphone}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `XynaBotz${iphone1}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `XynaBotz${iphone2}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `XynaBotz${iphone3}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `XynaBotz${iphone4}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `XynaBotz${iphone5}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `XynaBotz${iphone6}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `XynaBotz${buttonkal}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `XynaBotz${buttonvirus}` }, { quoted:m })
}
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: ppnyauser,  caption: `XynaBotz${ngazap(prefix)}`}, { quoted:m })
}
}
break
case 'sendvirus': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `XynaBotz${iphone}` }, { quoted:m })
}
break
//=================================================//
case 'sendvirus2': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `XynaBotz${iphone1}` }, { quoted:m })
}
break
//=================================================//
case 'sendvirus3': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `XynaBotz${iphone2}` }, { quoted:m })
}
break
//=================================================//
case 'sendvirus4': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `XynaBotz${iphone3}` }, { quoted:m })
}
break
//=================================================//
case 'sendvirus5': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `XynaBotz${iphone4}` }, { quoted:m })
}
break
//=================================================//
case 'sendvirus6': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `XynaBotz${iphone5}` }, { quoted:m })
}
break
//=================================================//
case 'sendvirus7': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `XynaBotz${iphone6}` }, { quoted:m })
}
break
//=================================================//
case 'sendvirus8': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `XynaBotz${buttonkal}` }, { quoted:m })
}
break
//=================================================//
case 'sendvirus9': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `XynaBotz${buttonvirus}` }, { quoted:m })
}
break
//=================================================//
case 'sendvirus10': {
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: ppnyauser,  caption: `XynaBotz${ngazap(prefix)}`}, { quoted:m })
}
break
//=================================================//
case 'jadijago': {
...
"degreesLatitude": -6.9367014,
"degreesLongitude": 107.7228574,
"caption": `© XynaBotz${ngazap(prefix)}`,
"sequenceNumber": "1657237469254001",
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: m.chat, quoted:m})
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© XynaBotz${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© XynaBotz${ngazap(prefix)}`,
...
user.afkReason = text
m.reply(`${m.pushName} Hello Saya Bot XynaBotz${text ? ': ' + text : ''}`)
}
break
//=================================================//
case '🔥': 
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME XynaBotz${ngazap(prefix)}`,
"groupName": `MY NAME XynaBotz${ngazap(prefix)}`,
...
haikal.sendMessage(m.chat, anuala, `XynaBotz${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
Telegram : https://t.me/xynabotz

Group Telegram : https://t.me/HaikalHw

Instagram : https://www.instagram.com/faelfilaa
`
...
if (isBan) return reply(`Lah Lu Kan Di Ban`)
reply(`◎ © Hay Kak ${pushname} 👋 Selamat ${salam}
Mau SewaBot Chat Owner XynaBotz wa.me/6285718828566`)
}
break
//=================================================//
...
"caption": "HELLO KAK WHATSAPP INI ASLI BUATAN XynaBotz SELAMAT MENCOBA 🥳",
}
}), { userJid: m.chat })
haikal.relayMessage(m.chat, document.message, { messageId: document.key.id })
...
"caption": "Hallo Kak Aplikasi Ini Adalah Buatan Asli XynaBotz Aman Dan Terpercaya Selamat Belajar ❤️",
}
}), { userJid: m.chat })
haikal.relayMessage(m.chat, document.message, { messageId: document.key.id })
reply('sukses Kirim Script')
...
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw1,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw2': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw2,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw3': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw3,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw4': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw4,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw5': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw5,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw6': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw6,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw7': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw7,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw8': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw8,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw9': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw9,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw10': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw10,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw11': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw11,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw12': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw12,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw13': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw13,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw14': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw14,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw15': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw15,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw16': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw16,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw17': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw17,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw18': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw18,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw19': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw19,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw20': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw20,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw21': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw21,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw22': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw22,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw23': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw23,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw24': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw24,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw25': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw25,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw26': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw26,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw27': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw27,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw28': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw28,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw29': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw29,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw30': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw30,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw31': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw31,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw32': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw32,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw33': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw33,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw34': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw34,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw35': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw35,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw36': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw36,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw37': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw37,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw38': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw38,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw39': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw39,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw40': {
if (!isRegistered) return replyReg(mess.verif)
if (isBan) return reply(`Lah Lu Kan Di Ban`)
haikal.sendMessage(m.chat, { image: hw40,  caption: `© Created By XynaBotz` }, { quoted:m })
}
break
case 'hw41': {
if (!isRegistered) return replyReg(mess.verif)
